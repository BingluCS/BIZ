// #ifndef SZ3_HUFFMAN_ENCODER_HPP_OMP
// #define SZ3_HUFFMAN_ENCODER_HPP_OMP
...
// template <class T>
// class HuffmanEncoder_OMP : public concepts::EncoderInterface_OMP<T> {
//    public:
...
//     ~HuffmanEncoder_OMP() override { SZ_FreeHuffman(); }
...
//         return out;
//     }
//         T* decode2(const uchar *&bytes, size_t targetLength) {
//         node root = treeRoot;
// // #ifdef SZ3_PRINT_TIMINGS
// //         Timer timer(true);
// // #endif
...
//         auto frequencies = frequencyList.data();
